...
const index = () => {
    ...
    const addTodo = async () => {
        try {
            ...
            axios
                .post(
                    "http://10.0.2.2:3000/todos/660f1050ca347f9b4470142d",
                    todoData
                )
                .then((response) => {
    ...
    const getUserTodos = async () => {
      try {
        const response = await axios.get(
          `http://10.0.2.2:3000/users/660f1050ca347f9b4470142d/todos`
        );
                    ...
                    {todos?.length > 0 ? (
                        ...
                        >
                            <Image
                                ...
                                source={{
                                    uri: "https://practicaltyping.com/wp-content/uploads/2022/01/todo-1.jpg",
                                }}
                            />
                            <Text
                                style={{
